...
export const PROFILE = {
  name: "Shubham",
  tagline: "See it. Believe it. Act on it — every single day.",
};
...
// PHOTOS — pictures of the life you're building. Replace in public/images/photos/.
export const PHOTOS = [
