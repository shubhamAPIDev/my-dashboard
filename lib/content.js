...
// EXAMS — fundamentals. Visa validity depends on passing all 5.
export const EXAMS = [
  { name: "Microeconomics",        date: "2026-07-20" },
  { name: "International Economics", date: "2026-07-22" },
  { name: "Macroeconomics",        date: "2026-07-24" },
  { name: "Economic Policy",       date: "2026-07-28" },
  { name: "Econometrics",          date: "2026-07-31" },
];
...
export const COUNTDOWNS = [
  ...
  { label: "Frankfurt move", date: "2026-07-01", urgent: true },
  { label: "EXAM 1 — Microeconomics", date: "2026-07-20", urgent: true },
  { label: "EXAM 2 — International Economics", date: "2026-07-22", urgent: true },
  { label: "EXAM 3 — Macroeconomics", date: "2026-07-24", urgent: true },
  { label: "Semester fee deadline", date: "2026-07-31", urgent: true },
  { label: "EXAM 4 — Economic Policy", date: "2026-07-28", urgent: true },
  { label: "EXAM 5 — Econometrics", date: "2026-07-31", urgent: true },
